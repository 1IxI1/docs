...
<Aside type="note" title="Compact version">
 [Tolk vs FunC: in short](/languages/tolk-vs-func/in-short)
</Aside>
...
All standard library functions are available by default. Downloading the stdlib and including it manually `#include "stdlib.fc"` is unnecessary. See [embedded stdlib](/languages/tolk-vs-func/in-detail#stdlib-is-now-embedded%2C-not-downloaded-from-github).
...
See the full comparison: [Tolk vs FunC: standard library](/languages/tolk-vs-func/stdlib).
...
<Accordion title="How are union types represented on the stack, at the TVM level?">
...
For details, see [Mutability in Tolk](/languages/tolk-vs-func/mutability).
